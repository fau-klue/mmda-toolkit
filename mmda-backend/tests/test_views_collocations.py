...
def test_get_coordinates(mock_coords, client, header):
    ...
    response = client.get(url_for('collocation.get_coordinates',
                                  username='student1',
...
def test_reload_coordinates(mock_coords, client, header):
    ...
    response = client.put(url_for('collocation.reload_coordinates',
                                  username='student1',
                                  collocation=1),
                          follow_redirects=True,
                          content_type='application/json',
...
def test_update_coordinates(client, header):
    ...
    response = client.put(url_for('collocation.update_coordinates',
                                  username='student1',
                                  collocation=1),
                          follow_redirects=True,
                          content_type='application/json',
...
def test_delete_coordinates(client, header):
    ...
    response = client.delete(url_for('collocation.delete_coordinates',
                                     username='student1',
                                     collocation=1),
                             follow_redirects=True,
                             content_type='application/json',
