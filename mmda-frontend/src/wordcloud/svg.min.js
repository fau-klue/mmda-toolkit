/*! svg.js v2.7.0 MIT*/ !(function(t, e) {
        ...
        return (
          e instanceof t.Event
            ...
            : this.node.dispatchEvent(
                (e = new t.CustomEvent(e, { detail: i, cancelable: !0 }))
              ),
          (this._event = e),
          this
        );
      ...
      extend: {
        ...
        lines: function() {
          var t = ((this.textPath && this.textPath()) || this).node,
            e = b.utils.map(b.utils.filterSVGElements(t.childNodes), function(
              t
            ) {
              return b.adopt(t);
            });
